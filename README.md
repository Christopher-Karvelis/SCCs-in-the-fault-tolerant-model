...
Therefore, the time complexity becomes <img src="https://render.githubusercontent.com/render/math?math=O(k*\frac{{n^2-n}{2} + n)">, the question is can we achieve something better than this?
